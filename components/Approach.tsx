...
const Approach = () => {
  return (
    <section className="w-full py-20">
      ...
      <div className="mx-auto my-20 flex flex-col items-center justify-center gap-4 lg:flex-row">
        <Card
  ...
  return (
    <div>
      <button className="relative inline-flex h-12 overflow-hidden rounded-full p-px focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 focus:ring-offset-slate-50">
        ...
        <span className=" inline-flex size-full cursor-pointer items-center justify-center rounded-full bg-slate-950 px-4 py-2 text-2xl font-bold text-white backdrop-blur-3xl">
          {order}
        </span>
      </button>
    </div>
